...
public enum GazelleProfile {
    ...
    LAB36_ACK                     ("1.3.6.1.4.12559.11.1.1.174", "LAB-36", "ACK", "2.5.1"),
    ...
    LAB_28_ORL_O34                ("1.3.6.1.4.12559.11.1.1.181", "LAB_28", "ORL^O34^ORL_O34", "2.5.1"),
    ...
    ITI_10_ADT_A31                ("1.3.6.1.4.12559.11.1.1.28",  "ITI-10", "ADT^A31^ADT_05", "2.5"),
