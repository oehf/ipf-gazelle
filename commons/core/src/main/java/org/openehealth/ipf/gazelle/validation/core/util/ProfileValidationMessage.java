...
public enum ProfileValidationMessage {
    ...
    COMPONENT_TYPE_MISSMATCH("Component '%1s'[2%s] is defined in the profile but does not exist in the Java class representing the segment", DATA_TYPE_ERROR, ERROR),
    HL7_DATATYPE_MISSMATCH("HL7 datatype '%1s' does not match the one declared in the profile (%2s)", DATA_TYPE_ERROR, ERROR),
